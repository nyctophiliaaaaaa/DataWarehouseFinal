  ...
  <div class="min-h-screen bg-pink-200 flex flex-col items-center justify-center px-4 relative">
    ...
    <div class="flex gap-6 mt-8">
      ...
      >
        ...
        {{ isLoading && currentStep === 'denorm' ? '⏳ Denormalizing...' : 'Denormalize' }}
...
const currentStep = ref(''); // Tracks which action is happening ('upload', 'clean', 'load', 'denorm')
...
const isLoaded = ref(false);   // True only after successful load
